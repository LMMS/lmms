...
static void stream_write_callback(pa_stream *s, size_t length, void *userdata) LMMS_NONBLOCKING
{
...
static void stream_state_callback(pa_stream* s, void* userdata) LMMS_NONBLOCKING
{
...
static void context_state_callback(pa_context *c, void *userdata) LMMS_NONBLOCKING
{
