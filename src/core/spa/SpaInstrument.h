...
class SpaInstrument : public Instrument
{
	Q_OBJECT
public:
	SpaInstrument(InstrumentTrack * _instrument_track , const char *libraryName, const Descriptor *plugin_descriptor);
...
private:
	...
	struct lmms_ports {
		...
		std::vector<float> l_unprocessed, r_unprocessed, l_processed, r_processed;
