...
Controller::Controller( ControllerTypes _type, Model * _parent,
	...
	JournallingObject(),
	m_valueBuffer( LmmsEngine::mixer()->framesPerPeriod() ),
...
{
	return s_periods * LmmsEngine::mixer()->framesPerPeriod();
}
...
{
	return runningFrames() / LmmsEngine::mixer()->processingSampleRate();
}
