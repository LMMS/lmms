	...
	m_stopAction(nullptr)
{
	...
	new QShortcut(QKeySequence(keySequence(Qt::SHIFT, Qt::Key_Space)), this, SLOT(togglePause()));
	new QShortcut(QKeySequence(keySequence(Qt::SHIFT, Qt::Key_F11)), this, SLOT(toggleMaximize()));
}
