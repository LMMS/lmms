	...
	m_editor(new PianoRoll())
{
	...
	glueAction->setShortcut(combine(Qt::CTRL, Qt::SHIFT, Qt::Key_G));
	...
	knifeAction->setShortcut(combine(Qt::SHIFT, Qt::Key_X));
	...
	fillAction->setShortcut(combine(Qt::CTRL, Qt::SHIFT, Qt::Key_F));
