...
void PianoRoll::setCurrentPattern( Pattern* newPattern )
{
	if( hasValidPattern() )
	{
		m_pattern->instrumentTrack()->pianoModel()->disconnect(this);
		m_pattern->instrumentTrack()->firstKeyModel()->disconnect(this);
		m_pattern->instrumentTrack()->lastKeyModel()->disconnect(this);
		m_pattern->instrumentTrack()->microtuner()->keymapModel()->disconnect(this);
		m_pattern->instrumentTrack()->microtuner()->keyRangeImportModel()->disconnect(this);
