	...
	m_hasFocus( false )
{
	...
	connect(m_closeOthersAction, SIGNAL(triggered(QAction*)), this, SLOT(emitCloseOthersSignal(SubWindow*)));
	//connect(this, &SubWindow::closeOthers, this, close);
	connect(this, SIGNAL(closeOthers(SubWindow*)), this, SLOT(close()));
