...
void ComboBox::paintEvent( QPaintEvent * _pe )
{
	...
	p.fillRect(2, 2, width() - 2, height() - 4, *background);
	...
	auto arrowPixmap = m_pressed ? arrowSelected : arrow;

	p.drawPixmap(width() - CB_ARROW_BTN_WIDTH + 3, 4, *arrowPixmap);
