	...
	ModelView(nullptr, this)
{
	...
	m_filterCutKnob = new Knob(KnobType::Bright26, tr("FREQ"), m_filterGroupBox, Knob::Mode::Legacy);
	m_filterCutKnob->setHintText(tr("Cutoff frequency:"), " " + tr("Hz"));
	filterLayout->addWidget(m_filterCutKnob);

	m_filterResKnob = new Knob(KnobType::Bright26, tr("Q/RESO"), m_filterGroupBox, Knob::Mode::Legacy);
