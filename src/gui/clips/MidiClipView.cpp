...
void MidiClipView::paintEvent( QPaintEvent * )
{
	...
	{
		// inner border
		p.setPen(lighter(bgColor, current ? 160 : 130));
		p.drawRect(1, 1, rect().right() - BORDER_WIDTH, rect().bottom() - BORDER_WIDTH);

		// outer border
		p.setPen(current ? lighter(bgColor, 130) : bgColor.darker(300));
