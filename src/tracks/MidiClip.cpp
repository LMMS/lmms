...
QPixmap * MidiClipView::s_stepBtnOn0 = NULL;
QPixmap * MidiClipView::s_stepBtnOn200 = NULL;
QPixmap * MidiClipView::s_stepBtnOff = NULL;
QPixmap * MidiClipView::s_stepBtnOffLight = NULL;
...
MidiClip * MidiClip::adjacentMidiClipByOffset(int offset) const
{
	...
	return dynamic_cast<MidiClip*>(clips.value(clipNum + offset, NULL));
}
...
void MidiClip::updateBBTrack()
{
	...
	if( gui && gui->pianoRoll() && gui->pianoRoll()->currentMidiClip() == this )
	{
