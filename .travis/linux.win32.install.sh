...
MINGW_PACKAGES="mingw32-x-libvorbis mingw32-x-fluidsynth mingw32-x-stk
	...
	mingw32-x-libgig mingw32-x-libsoundio mingw32-x-lame mingw32-x-qt5base sdl2-mingw-w64"
