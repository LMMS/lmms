...
В данной программе вы можете настраивать арпеджио по вкусу.</translation>
    ...
    <message>
        ...
        <translation>Этот регулятор изменяет частотный диапазон арпеджио: орпеджио будет проходить указанное число октав.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Понижать частоту</translation>
    </message>
    <message>
        <source>arpeggio direction = up and down</source>
        <translation>Поочерёдно поднимать и понижать частоту</translation>
    </message>
    <message>
        <source>arpeggio direction = random</source>
        <translation>Случайное направление</translation>
    </message>
    <message>
        <source>Chord range</source>
...
<context>
    ...
    <message>
        ...
        <translation>Этот регулятор позволяет изменять коэффициент усиления. Если вы установите 100%, то ничего не изменится, иначе звук будет громче или тише. (Заметьте, что при этом файл с образцом изменяться не будет.)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Эта ручка устанавливает место, с которого будет воспроизводиться текущий образец. Если включен автоповтор, то повтор будет осуществляться с этого места.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Эта ручка устанавливает место, до которого будет воспроизводиться текущий образец. Если включен автоповтор, то по достижении этой точки воспроизведение будет продолжаться с начальной точки.</translation>
    </message>
    <message>
        ...
        <translation>Нажмите здесь чтобы открыть другой файл. Учтите, что при открытии файла такие настройки как автоповтор, начальная и конечная точки, усиление и т. д. остаются в силе...</translation>
    </message>
    <message>
        ...
        <translation>Включение/выключение режима автоповтора.При включенном автоповторе часть образца между начальной и конечной точками будет повторяться. Это может пригодиться для имитации струнных или хора.</translation>
    </message>
    <message>
        ...
        <translation>Если вы нажмёте на эту кнопку, то осциллограмма образца будет прорисовываться с помощью линий. Это никак не повлияет на воспроизведение.</translation>
    </message>
    <message>
        ...
        <translation>Если вы нажмёте на эту кнопку, то осциллограмма образца будет прорисовываться с помощью точек. Это никак не повлияет на воспроизведение.</translation>
    </message>
    <message>
        <source>Amplify</source>
        <translation>Усиление</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Нажмите чтобы проиграть запись ритма/басов. Запись будет повторяться после окончания.</translation>
    </message>
    <message>
...
Рекомендуется копировать предусиановки и проекты и создавать ссылки на образцы, которые занимают гораздо больше места.</translation>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Мультимедийную студию для Linux</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка в конфигурационном файле</translation>
    </message>
    <message>
        <source>Error while parsing configuration-file %1.
The setup-wizard will be shown for reconfiguring LMMS.</source>
        <translation>Ошибка при чтении конфигурационного файла %1.
...
Now click on &apos;Next&apos; to get to the next page.</source>
        <translation>Перед началом работы нужно настроить LMMS. Этот мастер поможет вам создать собственные настройки.
...
Please select a directory:</source>
        <translation>При работе с LMMS вам потребуется рабочий каталог, где вы сможете хранить проекты, настройки, образцы звуков и т. д.
...
LMMS-working-directory. Run the setup-wizard now?</source>
        <translation>Судя по информации из конфигурационного файла LMMS, 
...
<context>
    ...
    <message>
        ...
        <translation>Длительность нарастания LFO:</translation>
    </message>
    <message>
        ...
        <translation>Этот регулятор устанавливает время возрастания для текущго LFO. Чем больше значение, тем дольше LFO возрастает до максимума.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Длительность задержки</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Глубина модуляции LFO</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Если вы хотите задать собственную форму волны (из файла), нажмите здесь, а потом перенесите мышью файл с образцом на график LFO.</translation>
    </message>
    <message>
        <source>Hint</source>
...
Проверьте, обладаете ли вы правами на запись в выбранный файл и содержащий его каталог и попробуйте снова!</translation>
    ...
    <message>
        ...
        <translation>Несжатый файл WAV (*.wav)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Переменный поток данных</translation>
    </message>
    <message>
        <source>use high-quality-mode (recommened)</source>
        <translation>Кодировать с повышенным качеством (рекомендуется)</translation>
    </message>
    <message>
...
Make sure, you have write access to the selected file/device!</source>
        <translation>Сохранение не удалось из-за ошибки открытия выходного файла или устройства.
Проверьте, обладаете ли вы правами на запись в выбранный файл/устройство!</translation>
    </message>
    <message>
        <source>Exporting project to %1</source>
        <translation>Экспортирование композиции в файл %1</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Соединить с устройством MIDI</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Создаю композицию...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>НАСТРОЙКА MIDI ДЛЯ ЭТОГО КАНАЛА</translation>
    </message>
    <message>
        <source>CHANNEL</source>
        <translation>КАНАЛ</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Отключить всплывающие подсказки (может помочь при прерывистом звуке)</translation>
    </message>
    <message>
        <source>Classical knob usability (move cursor around knob to change value)</source>
        <translation>Классические регуляторы (нужно двигать указателем мыши вокруг регулятора)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Окна в стиле GIMP (не МДИ)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не запускать мастер настройки после смены версии программы</translation>
    </message>
    <message>
...
Do you want to overwrite it?</source>
        <translation>Файл %1 существует. Перезаписать его?</translation>
    </message>
    <message>
...
Проверьте, обладаете ли вы правами на чтение выбранного файла и попробуйте снова.</translation>
    ...
    <message>
        ...
        <translation>Файл &quot;%1&quot; уже существует. Перезаписать его?</translation>
    </message>
    <message>
...
When you click right on this switch, all other tracks will be muted. This is useful, if you only want to listen to this track.</source>
        <translation>Вы можете заглушать эту дорожку или все дорожки кроме этой.
...
right click = mute all other tracks (solo)</source>
        <translation>Левая кнопка мыши отключает эту дорожку;
...
<context>
    ...
    <message>
        <source>Click here if you want a user-defined wave-shape for current oscillator.</source>
        <translation>Задать сигнал из файла (двойной щелчок мышью).</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть другое модульVST</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать/скрыть интерфейс VST</translation>
    </message>
    <message>
