...
private:
	...
	std::vector<class ClapFile> m_clapFiles; //!< Owns all loaded .clap files; Populated by findClapFiles()
	...
	auto getClapFiles() const -> const std::vector<class ClapFile>& { return m_clapFiles; }
};
