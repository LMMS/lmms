/*
 * ActiveRenderer.h - ActiveRenderer class for easily rendering projects
 *
...
class LMMS_EXPORT ActiveRenderer : public QThread
{
	Q_OBJECT
public:
	...
	ActiveRenderer( const AudioEngine::qualitySettings & _qs,
				...
				EndFn endFunction,
				void* getBufferData);
	~ActiveRenderer() override = default;
