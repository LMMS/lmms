...
class PianoRoll : public QWidget
{
	...
	Q_PROPERTY( int noteBorderWidth READ noteBorderWidth WRITE setNoteBorderWidth )
public:
	enum EditModes
	{
		ModeDraw,
	...
	int noteBorderWidth() const;
	void setNoteBorderWidth( const int i );
