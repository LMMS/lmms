...
public:
	...
	virtual QStringList readablePorts() const { return m_inputDevices.values(); }

	virtual QStringList writablePorts() const { return m_outputDevices.values(); }
...
private:
	...
	static void WINAPI CALLBACK inputCallback(
		HMIDIIN _hm, UINT _msg, DWORD_PTR _inst, DWORD_PTR _param1, DWORD_PTR _param2);
