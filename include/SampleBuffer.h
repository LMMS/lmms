...
//! if copies are made, the data is shared automatically. When modifications to this buffer is made, a deep copy of the
//! data is made if it is being shared, preventing modifications to the data being shared.
