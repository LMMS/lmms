...
public:
	...
	public:
		...
		int8_t operator[](int n) const {
			// remember the ChordSemiTones overloaded operator [], which returns the
	...
	private:
		...
		// This Klinc to implement the static QVector of data
		...
		static Init s_initializer; // The constructor which will get the data!
