...
ELSE()
  ...
  SET(BASHCOMP_SCRIPT "${CMAKE_CURRENT_BINARY_DIR}/install_bash_completion.sh")
...
#   can't handle on its own at INSTALL() time)
  ...
  if [ -w \"${BASHCOMP_USER_PATH}\" ]; then\n\
    BASHCOMP_PKG_PATH=\"@BASHCOMP_PKG_PATH@\"\n\
  fi\n\
  echo -e \"\\nInstalling bash completion...\"\\n\
  mkdir -p \"$BASHCOMP_PKG_PATH\"\n\
  cp \"${CMAKE_CURRENT_SOURCE_DIR}/${SCRIPT_NAME}\" \"$BASHCOMP_PKG_PATH\"\n\
  chmod ugo+r \"$BASHCOMP_PKG_PATH/${SCRIPT_NAME}\"\
  echo -e \"Bash completion for ${SCRIPT_NAME} has been installed to $BASHCOMP_PKG_PATH\"\
  ")
