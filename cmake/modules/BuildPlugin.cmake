...
MACRO(BUILD_PLUGIN PLUGIN_NAME)
	...
	INCLUDE_DIRECTORIES("${CMAKE_CURRENT_BINARY_DIR}" "${CMAKE_BINARY_DIR}" $<TARGET_PROPERTY:lmms_core_objs,INCLUDE_DIRECTORIES>"${CMAKE_SOURCE_DIR}/include" "${CMAKE_SOURCE_DIR}/include/core" "${CMAKE_SOURCE_DIR}/include/gui")
