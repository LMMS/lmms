...
# usage: BUILD_PLUGIN(<PLUGIN_NAME> <PLUGIN_SOURCES> MOCFILES <HEADERS_FOR_MOC> QRESOURCES <LIST_OF_FILES_TO_EMBED> UICFILES <UI_FILES_TO_COMPILE> )

INCLUDE(GenQrc)
MACRO(BUILD_PLUGIN PLUGIN_NAME)
	CMAKE_PARSE_ARGUMENTS(PLUGIN "" "" "MOCFILES;QRESOURCES;UICFILES" ${ARGN})
	...
	LIST(LENGTH PLUGIN_QRESOURCES QR_LEN)
	IF(QR_LEN)
		ADD_GEN_QRC(RCC_OUT "${PLUGIN_NAME}.qrc" PREFIX ${PLUGIN_NAME} ${PLUGIN_QRESOURCES})
	ENDIF()
