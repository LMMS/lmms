...
FUNCTION(INSTALL_TARGET_DEPENDENCIES)
	...
	FOREACH(TARGET ${DEPS_TARGETS})
		...
		foreach(lib ${target_libs})
			...
			if(TARGET ${lib})
				list(APPEND DEPS_LIB_DIRS "$<TARGET_FILE_DIR:${lib}>")
			elseif(NOT IS_ABSOLUTE ${lib})
				continue()
			endif()
	...
	DEFINE_INSTALL_VAR(NAME "DEPS_LIB_DIRS" CONTENT "${DEPS_LIB_DIRS}" GENERATOR_EXPRESSION)
