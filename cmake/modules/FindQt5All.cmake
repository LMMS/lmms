...
IF(NOT Qt5Core_FOUND)
	...
	IF(NOT QT_MISSING)
		...
		SET(Qt5_DIR "${QT_PATH}/lib/cmake/Qt5/" CACHE STRING "Where Qt5 can be found")
		SET(Qt5Test_DIR "${QT_PATH}/lib/cmake/Qt5Test" CACHE STRING "Where Qt5Test can be found")
	ENDIF()
ENDIF()
