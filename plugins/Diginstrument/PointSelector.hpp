...
std::vector<unsigned int> PointSelector::selectIndices(unsigned int beginIndex, unsigned int endIndex, double a, bool leftSide)
{
...
std::vector<unsigned int> PointSelector::selectIndices(unsigned int beginIndex, unsigned int endIndex, double a, unsigned int focusPoint)
{
