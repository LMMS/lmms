...
private:
	sample_t calcAllpassFilter(sample_t inSamp, sample_rate_t Fs, int filtNum, int channel, float a, float b);
	void multimodeFilter(sample_t in, float g, sample_t &lp, sample_t &hp, sample_t &filtBuf);
