/*
 * AudioRecorderView.cpp - Plugin to count beats per minute
 *
 *
...
namespace lmms::gui {
AudioRecorderView::AudioRecorderView(AudioRecorder* plugin)
...
void AudioRecorderView::updateLabels()
{
...
void AudioRecorderView::keyPressEvent(QKeyEvent* event)
{
	QWidget::keyPressEvent(event);
	if (!event->isAutoRepeat()) { m_plugin->onBpmClick(); }
}

void AudioRecorderView::closeEvent(QCloseEvent*)
{
