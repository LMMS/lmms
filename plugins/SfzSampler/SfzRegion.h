...
public:
	...
	//! Also handles sending the trigger to the currently active sounds, in case they need to release (such as on NoteOff)
	...
	void play(SampleFrame* workingBuffer, const fpp_t frames);
...
private:
	...
	//! Helper buffer to help accumulate audio from each of the active SfzRegionPlayStates
