/*
 * ArpeggiatorControls.cpp - A native arpeggiatorer
 *
...
#include "ArpeggiatorControls.h"
#include "Arpeggiator.h"
#include "lmms_math.h"


ArpeggiatorControls::ArpeggiatorControls( ArpeggiatorEffect * eff ) :
	EffectControls( eff ),
	m_effect( eff ),
...
ArpeggiatorControls::~ArpeggiatorControls()
{
}

void ArpeggiatorControls::saveSettings( QDomDocument & doc, QDomElement & elem )
{
...
void ArpeggiatorControls::loadSettings( const QDomElement & elem )
{
...
void ArpeggiatorControls::sampleRateChanged()
{
