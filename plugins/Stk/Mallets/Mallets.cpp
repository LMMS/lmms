...
MalletsInstrument::MalletsInstrument( InstrumentTrack * _instrument_track ):
	...
	m_f3fixedModel(true, this, tr( "Fixed 3" )),
	m_freq0Model(1.0f, 0.0f, 20.0f, 0.001f, this, tr( "Freq 0" )),		// Default values of resonators, hardness,
	m_freq1Model(3.99f, 0.0f, 20.0f, 0.001f, this, tr( "Freq 1" )),		// position, and stick, set to that of Marimba.
	m_freq2Model(10.65f, 0.0f, 20.0f, 0.001f, this, tr( "Freq 2" )),
	m_freq3Model(2443.0f, 0.0f, 20.0f, 0.001f, this, tr( "Freq 3" )),
	m_res0Model(0.9996f, 0.99f, 1.0f, 0.00001f, this, tr( "Res 0" )),
	m_res1Model(0.9994f, 0.99f, 1.0f, 0.00001f, this, tr( "Res 1" )),
	m_res2Model(0.9994f, 0.99f, 1.0f, 0.00001f, this, tr( "Res 2" )),
	m_res3Model(0.999f, 0.99f, 1.0f, 0.00001f, this, tr( "Res 3" )),
	m_vol0Model(0.04f, 0.0f, 0.1f, 0.001f, this, tr( "Vol 0" )),
	m_vol1Model(0.01f, 0.0f, 0.1f, 0.001f, this, tr( "Vol 1" )),
	m_vol2Model(0.01f, 0.0f, 0.1f, 0.001f, this, tr( "Vol 2" )),
	m_vol3Model(0.008f, 0.0f, 0.1f, 0.001f, this, tr( "Vol 3" )),
	m_hardnessModel(55.0f, 0.0f, 128.0f, 0.1f, this, tr( "Hardness" )),
	m_positionModel(57.0f, 0.0f, 128.0f, 0.1f, this, tr( "Position" )),
	...
	m_stickModel(12.0f, 0.0f, 128.0f, 0.1f, this, tr( "Stick mix" )),
	m_presetsModel(this),
...
{
	MalletsInstrument * inst = castModel<MalletsInstrument>();
	inst->m_f0fixedModel.value() ? inst->m_freq0Model.setRange(0.0f, 10000.0f, 0.1f)
									: inst->m_freq0Model.setRange(0.0f, 20.0f, 0.01f);
	inst->m_f1fixedModel.value() ? inst->m_freq1Model.setRange(0.0f, 10000.0f, 0.1f)
									: inst->m_freq1Model.setRange(0.0f, 20.0f, 0.01f);
	inst->m_f2fixedModel.value() ? inst->m_freq2Model.setRange(0.0f, 10000.0f, 0.1f)
									: inst->m_freq2Model.setRange(0.0f, 20.0f, 0.01f);
	inst->m_f3fixedModel.value() ? inst->m_freq3Model.setRange(0.0f, 10000.0f, 0.1f)
									: inst->m_freq3Model.setRange(0.0f, 20.0f, 0.01f);
}
