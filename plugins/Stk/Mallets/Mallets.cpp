...
MalletsInstrument::MalletsInstrument( InstrumentTrack * _instrument_track ):
	...
	m_vol0Model(0.025f, 0.0f, 0.1f, 0.001, this, tr( "Vol 0" )),
	m_vol1Model(0.015f, 0.0f, 0.1f, 0.001, this, tr( "Vol 1" )),
	m_vol2Model(0.015f, 0.0f, 0.1f, 0.001, this, tr( "Vol 2" )),
	m_vol3Model(0.015f, 0.0f, 0.1f, 0.001, this, tr( "Vol 3" )),
