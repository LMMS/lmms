...
wurleyProcessor::wurleyProcessor( sample_rate_t _sample_rate ):
	stkProcessor<wurleyModel, Wurley>( _sample_rate )
{
}
...
wurleyProcessor::~wurleyProcessor()
{
}
...
void wurleyProcessor::setControls( wurleyModel * _model )
{
