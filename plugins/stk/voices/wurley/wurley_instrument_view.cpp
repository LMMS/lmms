...
wurleyInstrumentView::wurleyInstrumentView( wurleyInstrument * _instrument, QWidget * _parent ) :
	stkInstrumentView<wurleyInstrument>( _instrument, _parent )
{
...
wurleyInstrumentView::~wurleyInstrumentView()
{
}
...
void wurleyInstrumentView::modelChanged( void )
{
	stkInstrumentView<wurleyInstrument>::modelChanged();
	
	wurleyInstrument * inst = castModel<wurleyInstrument>();
