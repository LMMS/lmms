...
percfluteProcessor::percfluteProcessor( sample_rate_t _sample_rate ):
	stkProcessor<percfluteModel, PercFlut>( _sample_rate )
{
}
...
percfluteProcessor::~percfluteProcessor()
{
}
...
void percfluteProcessor::setControls( percfluteModel * _model )
{
