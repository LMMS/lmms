...
percfluteInstrumentView::percfluteInstrumentView( percfluteInstrument * _instrument, QWidget * _parent ) :
	stkInstrumentView<percfluteInstrument>( _instrument, _parent )
{
...
percfluteInstrumentView::~percfluteInstrumentView()
{
}
...
void percfluteInstrumentView::modelChanged( void )
{
	stkInstrumentView<percfluteInstrument>::modelChanged();
	
	percfluteInstrument * inst = castModel<percfluteInstrument>();
