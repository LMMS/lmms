...
rhodeyInstrumentView::rhodeyInstrumentView( rhodeyInstrument * _instrument, QWidget * _parent ) :
	stkInstrumentView<rhodeyInstrument>( _instrument, _parent )
{
...
rhodeyInstrumentView::~rhodeyInstrumentView()
{
}
...
void rhodeyInstrumentView::modelChanged( void )
{
	stkInstrumentView<rhodeyInstrument>::modelChanged();
	
	rhodeyInstrument * inst = castModel<rhodeyInstrument>();
