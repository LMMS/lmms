...
tubebellInstrumentView::tubebellInstrumentView( tubebellInstrument * _instrument, QWidget * _parent ) :
	stkInstrumentView<tubebellInstrument>( _instrument, _parent )
{
...
tubebellInstrumentView::~tubebellInstrumentView()
{
}
...
void tubebellInstrumentView::modelChanged( void )
{
	stkInstrumentView<tubebellInstrument>::modelChanged();
	
	tubebellInstrument * inst = castModel<tubebellInstrument>();
